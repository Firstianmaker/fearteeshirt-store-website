  ...
  <body>
    ...
    <div class="bg-white dark:bg-gray-900">
      <div class="flex justify-center h-screen">
          ...
          <div class="container mx-auto">
            <div class="flex justify-between items-center">
              ...
              <ul class="mt-2 hidden lg:flex justify-between">
                ...
                <li class="mr-4">
                  <a href="login.php" class="text-white hover:text-green-400"
                    >Sign In</a
                  >
                </li>
                <li>
        ...
        <div
          class="mt-4 flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6"
        >
          <div class="flex-1">
            <div class="text-center">
              ...
              <p class="mt-3 text-gray-500 dark:text-gray-300">
                Sign Up to Buy Feartee Product
              </p>
            </div>
