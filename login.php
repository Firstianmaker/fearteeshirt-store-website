      ...
      <nav class="fixed top-0 left-0 w-full bg-transparent z-50">
        <div class="container mx-auto">
          <div class="flex justify-between items-center">
            ...
            <ul class="mt-2 hidden lg:flex justify-between">
              <li class="mr-4">
                <a href="adminlogin.php" class="text-white hover:text-red-400">Admin</a>
              </li>
              <li class="mr-4">
                <a href="login.php" class="text-white hover:text-green-400">Sign In</a>
              </li>
              <li>
                <a href="register.php" class="text-white hover:text-blue-400">Sign Up</a>
              </li>
            </ul>
          </div>
        </div>
      </nav>
      <div class="hidden bg-cover lg:block lg:w-2/3" style="background-image: url(img/img5.jpg)">
        <div class="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
          <div>
            <h2 class="text-4xl font-bold text-white">Feartee</h2>
          ...
          <div class="mt-8">
            <form method="post">
              <div>
                ...
                <input type="email" name="email" id="email" placeholder="example@example.com" class="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 dark:bg-gray-900 border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
              </div>
              ...
              <div class="mt-6">
                <button class="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:outline-none focus:bg-blue-400 focus:ring focus:ring-blue-300 focus:ring-opacity-50" type="submit" name="submit">
                  Sign in
                </button>
              </div>
            </form>
            ...
            <p class="mt-6 text-sm text-center text-gray-400">
              ...
              <a href="register.php" class="text-blue-500 focus:outline-none focus:underline hover:underline">Sign up</a>.
            </p>
          </div>
        </div>
      </div>
